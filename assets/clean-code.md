...
#### [About camelCase](\#about-camelcase)
...
#### [Conventions are only conventions](\#conventions-are-only-conventions)
...
#### [A good name is descriptive](\#a-good-name-is-descriptive)
...
#### [Use consistent vocabulary](\#use-consistent-vocabulary)
...
### [Use searchable and immediately understandable names](\#use-searchable-and-immediately-understandable-names)
...
#### [Tell why, not how](\#tell-why-not-how)
...
2. To help better understand good comment practices, read about [comments telling us why code works](https://blog.codinghorror.com/code-tells-you-how-comments-tell-you-why/) as well as how to [code without comments](https://blog.codinghorror.com/coding-without-comments/).
